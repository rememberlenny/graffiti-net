...
sudo service unicorn_graffiti_net <start|stop|restart>
sudo service sidekiq_graffiti_net <start|stop>
```
...
```
/home/deployer/apps/graffiti_net/shared/.env.production
```

After making changes to this file, be sure to restart the application:

```
sudo service unicorn_graffiti_net restart
sudo service sidekiq_graffiti_net stop
sudo service sidekiq_graffiti_net start
```
